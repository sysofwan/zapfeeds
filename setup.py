...
subprocess.call([os.path.join('flask', bin, 'pip'), 'install', 'numpy'])
subprocess.call([os.path.join('flask', bin, 'pip'), 'install', 'Cython'])
subprocess.call([os.path.join('flask', bin, 'pip'), 'install', 'git+git://github.com/scipy/scipy/'])
...
subprocess.call([os.path.join('flask', bin, 'pip'), 'install', '--pre', 'langid'])