...
def get_date_feature(content_id=0, content_data=''):
    """
    status: required
    @todo:
    """
...
def get_desc_feature(content_id=0, content_data=''):
    """
    status: optional
    @todo:
    """
...
def thumbnail_exist(content_id=0, content_data=''):
    """
    status: optional
    """
    data = ''
...
def icon_exist(content_id=0, content_data=''):
    """
    status: optional
    """
    data = ''
...
def content_type_feature(content_id=0, content_data=''):
    """
    status: optional
    """
    data = 0
...
def view_data(content_id=0, content_data={}):
    ...
    date = get_date_feature(content_id=content_id,
                            content_data=date_data)

    description = get_desc_feature(content_id=content_id,
    ...
    thumbnail = thumbnail_exist(content_id=content_id,
                                content_data=thumbnail_data)

    icon = icon_exist(content_id=content_id,
                      content_data=icon_data)

    content_type = content_type_feature(content_id=content_id,
...
def get_text_feature(content_id=0, content_data='', html_data=''):
    """
    status: optional
    """
    text_data = ''
...
def access_data(content_id=0, content_data={}):
    ...
    text = get_text_feature(content_id=content_id,
